...
namespace WinAppProyectoI
{
    public partial class OficinaBSalida : Form
    {
        ...
        private void BttBuscar_Click(object sender, EventArgs e)
        {
            ...
            oficina = matSeg1.TblMatSeg.Select("Codigo='" + TxtBxCodigo.Text + "'");
            ...
            if (oficina.Length > 0)
            {
                ...
                if (objModificar.ShowDialog() == DialogResult.OK)
                {
                    ...
                    oficina[0]["FechaS"] = objModificar.dates.Text;
                    oficina[0]["NombreRes"] = objModificar.TxtBxNombreUsuario.Text;
                    oficina[0]["Cantidad"] = objModificar.LblC.Text;
                    oficina[0].AcceptChanges();
                    matSeg1.TblMatSeg.WriteXml(Application.StartupPath + "\\ArchOficina.xml");
