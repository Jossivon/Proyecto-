    ...
    public partial class MatSegBEliminar : Form
    {
        ...
        private void BttBuscar_Click(object sender, EventArgs e)
        {
            ...
            if (mats.Length > 0)
            {
                ...
                objEliminar.LblNombreR.Text = mats[0]["Cedula"].ToString();
        ...
        private void TxtBxCodigo_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == (Char)Keys.Enter)
            {
                try
                {
                    ...
                    {
                        MessageBox.Show("El codigo a buscar debe ser mayor a 1", "AVISO", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Warning);
                        TxtBxCodigo.Text = "";
                    }
                ...
                {
                    MessageBox.Show("El código debe ser númerico", "AVISO", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Warning);
                    TxtBxCodigo.Text = "";
                }
            }
        }
